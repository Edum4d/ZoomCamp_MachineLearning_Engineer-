...
@app.get("/")
def root():
    return {"message": "Loan prediction API up!"}
...
def predict(row: LoanRow):
    ...
    proba_default = float(model.predict(dmatrix)[0])   # probabilidade de 1
    threshold = 0.5
